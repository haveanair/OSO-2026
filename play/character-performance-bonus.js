...
(function(){
  ...
  const CHANGELOG=[
    ...
    {date:'2026.09.07',title:'비단쌓기 엔들리스 업데이트',items:['일반 15단과 엔들리스 모드 분리, 엔들리스는 10단마다 돌파','GREAT/PERFECT 성공 시 비단 폭 회복, PERFECT 3회마다 하트 +1','하모·논개 전용 판정보정 적용','일시정지·모바일 HUD·구조물 격파 연출 강화','하늘→우주 자연 전환']},
